...
# Purpose: Convert a .bed file with 6 columns into a gtf format for transposable element annotation
# Created: 09/2017

# This script accepts a nonstandard .bed file generated by the Freeling Lab's repeatmasker workflow in the format:
...
parser = ArgumentParser(description='Converts a .bed file with 6 columns to gtf. It requires that you know the '
                                    ...
                                    'option. This was created to convert a bed file for TE annotations, so use for '
                                    'other purposes will require modification.')
